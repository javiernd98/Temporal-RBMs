...
def main():
    ...
    # --- OPTIMIZACIÓN: Movemos todo a la GPU de una sola vez ---
    ...
    # --- OPTIMIZACIÓN: Uso de DataLoader nativo ---
        ...
        with tqdm(total=N_UPDATES, desc="Training RBM", unit="upd") as pbar:
            while update_counter < N_UPDATES:
                ...
                for (batch,) in train_loader:
                    ...
                    # El batch ya está en GPU gracias al DataLoader sobre el TensorDataset en GPU
