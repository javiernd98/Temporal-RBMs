...
# Más adelante meteremos las clases en un mismo directorio
...
# ==========================================
# NUEVO: DATASET PARA VENTANA DESLIZANTE
# ==========================================
...
def main():
    ...
    # --- OPTIMIZACIÓN: Movemos todo a la GPU ---
    ...
    # --- OPTIMIZACIÓN: DataLoader con Dataset personalizado ---
    # Nota: Usamos shuffle=True para barajar las VENTANAS extraídas, 
    # rompiendo la correlación temporal entre lotes (bueno para el gradiente).
    train_dataset = cRBMDataset(train_data_gpu, N_PAST)
    train_loader = DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True, drop_last=True)
    
    # Creamos un batch de test fijo para la validación (evitar recálculos)
    ...
    # Aquí podríamos añadir una inicialización estadística para los sesgos base si quisieras
    ...
    print(f"⏱️ Tiempo total: {time.time()-start_train:.2f}s")
